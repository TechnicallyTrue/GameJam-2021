    ...
    class Char:
        def __init__(self):
            ...
            if self.body == "body 1":
                ...
                self.body_colour_a_A = "body_colour_a_1 angry.png"
                self.body_colour_b_A = "body_colour_b_1 angry.png"
                self.body_colour_c_A = "body_colour_c_1 angry.png"
                self.body_colour_a_H = "body_colour_a_1 happy.png"
                self.body_colour_b_H = "body_colour_b_1 happy.png"
                self.body_colour_c_H = "body_colour_c_1 happy.png"
                self.body_lines_N = "body_lines_1 neut.png"
                self.body_lines_A = "body_lines_1 angry.png"
                self.body_lines_H = "body_lines_1 happy.png"
            ...
            if self.body == "body 2":
                ...
                self.body_colour_a_A = "Body_Colour_A_2 angry.png"
                self.body_colour_b_A = "body_colour_b_2 neut.png"
                self.body_colour_c_A = "body_colour_c_2 angry.png"
                self.body_colour_a_H = "body_colour_a_2 neut.png"
                self.body_colour_b_H = "body_colour_b_2 neut.png"
                self.body_colour_c_H = "body_colour_c_2 neut.png"
                self.body_lines_N = "body_lines_2 neut.png"
                self.body_lines_A = "body_lines_2 angry.png"
                self.body_lines_H = "body_lines_2 neut.png"
